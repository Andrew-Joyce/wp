                    ...
                    <fieldset id="fieldset-session-<?php echo $movieCode; ?>">
                        ...
                        <div class="<?php echo strtolower(str_replace(' ', '-', $movieDetails['title'])); ?>">
                            ...
                            <?php foreach ($screenings as $day => $screening) { ?>
                                <div class="session">
                                    <input type="radio" name="session[<?php echo $movieCode; ?>]" id="session-<?php echo $movieCode . '-' . $day; ?>" value="<?php echo $screening['time']; ?>">
                                    <label for="session-<?php echo $movieCode . '-' . $day; ?>"><?php echo $day; ?> - <?php echo $screening['time']; ?></label>
                                </div>
                            <?php } ?>
                        </div>
                    </fieldset>
