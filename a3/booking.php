...
<body>
    ...
    <legend>Contact Information:</legend>
        ...
        <div>
            <button type="button" class="contact-Button unselected" id="remember-btn">Remember Me</button>
            <button type="button" class="contact-Button unselected" id="forget-btn">Forget Me</button>
        </div>
    </fieldset>
